...
setwd("/Users/annabellestanley/Documents/R_projects/OptPrivateLandCons/ExtraTutorialFiles")

#data=read_delim("data_breast_cancer2.csv", delim = ".", col_names = TRUE) 
#delim wasn't working so used brute force in excel... 

data <- read_excel("data_breast_cancer2.xlsx")
