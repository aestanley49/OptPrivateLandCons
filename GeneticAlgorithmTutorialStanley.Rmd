...
For this problem, we want the number of patches that maximizes the number of herp species. So the simplest version of our fitness function would be: 
```{r}
fitFunc <- function(x) {
...
fitFunc <- function(x) {
  ...
  current_n_patches <- if_else(current_n_herps < 9, 0, current_n_patches)
  return(current_n_patches)
}
...
!!!! Having issues here where want to negate fitness function but not sure how to do it... 
```{r}
data <- Herps
